    ...
    <section className='pt-32 pb-16' id='testimonials'>
        ...
        <motion.div            
            ...
            <div className='md:flex md:justify-between gap-8'>
                <motion.div
                    className={`md:w-1/3 bg-blue ${testimonialsStyles} before:content-person1`}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
                    transition={{ duration: 0.5 }}
                ...
                >
                    <p className='font-playfair text-6xl'>"</p>
                     <p className="text-center text-xl"> Lorem ipsum dolor, sit amet consectetur adipisicing elit Lorem ipsum dolor sit..</p>
                </motion.div>

                <motion.div
                    className={`md:w-1/3 bg-red ${testimonialsStyles} before:content-person2`}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
                ...
                <motion.div
                    className={`md:w-1/3 bg-yellow ${testimonialsStyles} before:content-person3`}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
